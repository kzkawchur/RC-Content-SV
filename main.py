...
def run_web_server():
    # Render ডিফল্টভাবে ৮MD বা ৮০৮০ পোর্ট খুঁজে
    port = int(os.environ.get("PORT", 8080))
    app.run(host='0.0.0.0', port=port)

# আলাদা থ্রেডে সার্ভারটি চালু করা যাতে বটের কাজে বাধা না দেয়
...
# --- ৩. কনফিগারেশন (Variables থেকে নিবে) ---
...
async def start(client, message):
    await message.reply_text(
        ...
        "আমি রেস্ট্রিক্টেড চ্যানেলের ভিডিও ডাউনলোড করতে পারি।\n"
        "**কীভাবে ব্যবহার করবেন:**\n"
        "১. আমাকে ভিডিওর লিংকটি পাঠান।\n"
        "২. যদি চ্যানেলটি প্রাইভেট হয়, তবে আপনার আইডিটি ওই চ্যানেলে জয়েন করা থাকতে হবে।"
    )
...
async def handle_link(client, message):
    ...
    try:
        ...
        # ইউজারবট কানেকশন চেক (Client is already connected এরর ফিক্স)
